...
// import 'package:voice_buddies_web/admin/approvedUsers/voice_recording_widget.dart';
...
// class ApprovedUserScreen extends StatefulWidget {
//   @override
//   _ApprovedUserScreenState createState() => _ApprovedUserScreenState();
// }

// class _ApprovedUserScreenState extends State<ApprovedUserScreen> {
...
//       ),
//       body: Obx(() {
//         if (userController.approvedUsers.isEmpty) {
//           return const Center(child: Text("No Approved Users"));
//         }

//         final filteredUsers = userController.approvedUsers.where((user) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        final sortedUsers = userController.approvedUsers
          ..sort((a, b) {
            final dateA =
                        ...
                        child: DataTable(
                          ...
                          rows: paginatedUsers.map((user) {
                            final String voiceRecordingUrl =
                                user.voiceRecording.toString();
                            return DataRow(cells: [
                              DataCell(Text(user.name ?? "Unknown Name")),
